...
-- Markdown Preview
vim.keymap.set("n", "<leader>mm", ":MarkdownPreviewToggle<CR>", { desc = "Toggle MarkdownPreview", silent = true })
...
vim.keymap.set("n",          "<leader>ghu", ":Gitsigns undo_stage_buffer<CR>",              { desc = "Undo Stage Hunk", silent = true })
vim.keymap.set("n",          "<leader>ghd", "Gitsigns diffthis<CR>",                        { desc = "Diff This", silent = true })
vim.keymap.set("n",          "<leader>ghD", '<cmd>lua require"gitsigns".diffthis("~") end', { desc = "Diff This ~", silent = true })
